...
public class CrystalRangeSeekbar extends View {
    ...
    protected float getThumbDiameter(){
        return (thumbDiameter > 0) ? thumbDiameter :  getResources().getDimension(com.example.crystalrangeseekbar.R.dimen.thumb_width);
    }
    ...
    protected int getBarColorMode(final TypedArray typedArray) {
        return typedArray.getInt(com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar_bar_color_mode, 0);
    }

    protected float getBarHeight(final TypedArray typedArray){
        return typedArray.getDimensionPixelSize(com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar_bar_height, 0);
    }
    ...
    protected int getBarGradientStart(final TypedArray typedArray) {
        return typedArray.getColor(com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar_bar_gradient_start, Color.GRAY);
    }

    protected int getBarGradientEnd(final TypedArray typedArray) {
        return typedArray.getColor(com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar_bar_gradient_end, Color.DKGRAY);
    }

    protected int getBarHighlightColorMode(final TypedArray typedArray) {
        return typedArray.getInt(com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar_bar_highlight_color_mode, 0);
    }
    ...
    protected int getBarHighlightGradientStart(final TypedArray typedArray) {
        return typedArray.getColor(com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar_bar_highlight_gradient_start, Color.DKGRAY);
    }

    protected int getBarHighlightGradientEnd(final TypedArray typedArray) {
        return typedArray.getColor(com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar_bar_highlight_gradient_end, Color.BLACK);
    }
    ...
    protected int getDataType(final TypedArray typedArray){
        return typedArray.getInt(com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar_data_type, DataType.INTEGER);
    }

    protected boolean isSeekBarTouchEnabled(final TypedArray typedArray){
        return typedArray.getBoolean(com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar_seek_bar_touch_enabled, false);
    }

    protected float getDiameter(final TypedArray typedArray){
        return typedArray.getDimensionPixelSize(com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar_thumb_diameter, getResources().getDimensionPixelSize(com.example.crystalrangeseekbar.R.dimen.thumb_height));
    }
